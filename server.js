...
var agenda = require('agenda')({
    db: {
        address: 'mongodb://viren:Vpsk05@g@ds029605.mongolab.com:29605/viren/test'
    }
});
...
mongoose.connect('mongodb://viren:Vpsk05@g@ds029605.mongolab.com:29605/viren/test');

var app = express();
app.get('/ping', function(req, res) {
    res.send({
        ping: 'hello this is server and I am alive!'
    });
});
